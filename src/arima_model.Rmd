...
```{r}
results_list <- list(
  h1  = list(pred = arima1c$pred,  errors = arima1c$errors),
  h3  = list(pred = arima3c$pred,  errors = arima3c$errors),
  h6  = list(pred = arima6c$pred,  errors = arima6c$errors),
  h12 = list(pred = arima12c$pred, errors = arima12c$errors)
)
